...
create table workunit_header 
  (
    ...
    fragment by expression
      (mod(id,8)=0) in workunit01_dbs,
      (mod(id,8)=1) in workunit02_dbs,
      (mod(id,8)=2) in workunit03_dbs,
      (mod(id,8)=3) in workunit04_dbs,
      (mod(id,8)=4) in workunit05_dbs,
      (mod(id,8)=5) in workunit06_dbs,
      (mod(id,8)=6) in workunit07_dbs,
      (mod(id,8)=7) in workunit08_dbs,
      extent size 2097150 next size 2047150;
